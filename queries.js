    ...
    db.all(sql, params,
      function (err, rows) {
        ...
        aux.forEach(element => {
          ...
          element.median = d3.median(element.percentages);
        });
        resolve(aux);
      }
    );
